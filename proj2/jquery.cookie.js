...
<meta content="2sGFgmqDgncdt8RyToXqhi6ghPe6+oyxC49leKTs1JQ=" name="csrf-token" />
    ...
    <link href="https://a248.e.akamai.net/assets.github.com/assets/github2-5f01d9908267bc69820a10a5e9a29c9a53c586c2.css" media="screen" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="0103203ca27b96f4188863cab07321bf">
        ...
        <link data-pjax-transient rel='permalink' href='/carhartl/jquery-cookie/blob/eb39ce5e270198be485f3e4ecd30c89ffbd6be02/jquery.cookie.js'>
  ...
  <input type="text" name="q" id="js-command-bar-field" placeholder="Search or type a command" tabindex="1" data-username="brysonthor" autocapitalize="off">
  ...
  <ul class="top-nav">
    ...
    <ul id="user-links">
      <li>
        <a href="https://github.com/brysonthor" class="name">
          <img height="20" src="https://secure.gravatar.com/avatar/d41d2ea90096c81d5600a37d0fe53880?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="20" /> brysonthor
        </a>
      </li>
      <li>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="2sGFgmqDgncdt8RyToXqhi6ghPe6+oyxC49leKTs1JQ=" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="268027" />
    ...
    <li class="js-toggler-container js-social-container starring-container ">
      <a href="/carhartl/jquery-cookie/unstar" class="minibutton js-toggler-target star-button starred upwards" title="Unstar this repo" data-remote="true" data-method="post" rel="nofollow">
        <span class="mini-icon mini-icon-remove-star"></span>
        <span class="text">Unstar</span>
      </a>
      <a href="/carhartl/jquery-cookie/star" class="minibutton js-toggler-target star-button unstarred upwards" title="Star this repo" data-remote="true" data-method="post" rel="nofollow">
        <span class="mini-icon mini-icon-star"></span>
        <span class="text">Star</span>
      </a>
      <a class="social-count js-social-count" href="/carhartl/jquery-cookie/stargazers">2,983</a>
    </li>

        <li>
          <a href="/carhartl/jquery-cookie/fork" class="minibutton js-toggler-target fork-button lighter upwards" title="Fork this repo" rel="nofollow" data-method="post">
            <span class="mini-icon mini-icon-branch-create"></span>
            <span class="text">Fork</span>
          </a>
          <a href="/carhartl/jquery-cookie/network" class="social-count">1,060</a>
        </li>
  ...
  <ul class="tabs">
    <li><a href="/carhartl/jquery-cookie" class="selected" highlight="repo_source repo_downloads repo_commits repo_tags repo_branches">Code</a></li>
    <li><a href="/carhartl/jquery-cookie/network" highlight="repo_network">Network</a></li>
    <li><a href="/carhartl/jquery-cookie/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>0</span></a></li>

      <li><a href="/carhartl/jquery-cookie/issues" highlight="repo_issues">Issues <span class='counter'>2</span></a></li>

      <li><a href="/carhartl/jquery-cookie/wiki" highlight="repo_wiki">Wiki</a></li>


    <li><a href="/carhartl/jquery-cookie/graphs" highlight="repo_graphs repo_contributors">Graphs</a></li>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
          <li><a href="/carhartl/jquery-cookie/tags" class="tabnav-tab" highlight="repo_tags">Tags <span class="counter ">5</span></a></li>
    </ul>
...
<!-- blob contrib key: blob_contributors:v21:dc34367d783fad098b9ff31a2e611d58 -->
<!-- blob contrib frag key: views10/v8/blob_contributors:v21:dc34367d783fad098b9ff31a2e611d58 -->
...
<div id="slider">
  ...
  <div class="commit file-history-tease">
    ...
    <time class="js-relative-date" datetime="2013-02-26T03:14:07-08:00" title="2013-02-26 03:14:07">February 26, 2013</time>
    <div class="commit-title">
        <a href="/carhartl/jquery-cookie/commit/eb39ce5e270198be485f3e4ecd30c89ffbd6be02" class="message">Fixing writing/removing a cookie with a name that contains characters…</a>
    </div>
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/carhartl/jquery-cookie/blob/eb39ce5e270198be485f3e4ecd30c89ffbd6be02/jquery.cookie.js" data-title="jquery-cookie/jquery.cookie.js at master · carhartl/jquery-cookie · GitHub" data-type="blob">
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2013 <span title="0.05385s from fe17.rs.github.com">GitHub</span>, Inc. All rights reserved.</p>
  ...
  <div class="fullscreen-sidebar">
    ...
    <span id='server_response_time' data-time='0.05437' data-host='fe17'></span>
